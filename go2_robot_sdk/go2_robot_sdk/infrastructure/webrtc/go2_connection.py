...
class Go2Connection:
    ...
    def _decrypt_con_notify_data(self, encrypted_b64: str) -> str:
        """Decrypt con_notify data using AES-GCM with predefined key"""
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            try:
                ...
                if data2 == 2:
                    data1 = self._decrypt_con_notify_data(data1)
